...
| DESCRIPTION		| The LAGO project operates its WCD by using three different types of electronics: BRC, MEX and AUG. Here you will find the latest stable (prod) all-in-one version for the data acquisition systems of the LAGO Project |
